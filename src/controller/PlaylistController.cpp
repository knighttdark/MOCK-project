...
// PlaylistController::PlaylistController() {managerController = &ManagerController::getInstance();}
...
//             PlaylistLibrary& playlistLibrary = managerController->getManagerModel()->getPlaylistLibrary();
//             const auto& playlists = playlistLibrary.getPlaylists();
...
PlaylistController::PlaylistController() {
    managerController = &ManagerController::getInstance(); // Use default initialization
}
